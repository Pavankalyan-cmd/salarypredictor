...
model = pickle.load(
    open(r'C:\Users\nicho\Desktop\projects\salarypredictor\linear_regression_model.pkl', 'rb'))
...
if st.button("Predict Salary"):
    ...
    # Display the result
    st.success(f"The predicted salary for {
               years_experience} years of experience is: ₹{prediction[0]:,.2f}")
